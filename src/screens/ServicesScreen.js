...
const ServicesScreen = ({navigation, route}) => {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: Colors.appBackground}} >
      ...
      <View style={{ marginBottom: showTrackComponent? 60:0, marginTop: 10, flex: 1, alignItems: 'center',  backgroundColor: Colors.appBackground,  width: '100%'}}>
        <SwipeListView
            style={{}}
            disableRightSwipe
            ...
            renderItem={ ({item, rowMap}) => (
              <Animatable.View delay={50 * rowMap} animation={'slideInRight'} style={{
                ...
                <View style={{flexDirection: 'row', alignItems: 'center'}}>
                  ...
                  <View style={{marginLeft: 10, width: '70%', alignItems: 'flex-start'}}>
                    ...
                    <Title size={15} label={"Ordered On: " + item.orderedOn} bold={true} color='grey'/>
                  </View>
                </View>
              </Animatable.View>
            )}
            renderHiddenItem={(data, rowMap) => (
              <View style={styles.rowBack}>
                <TouchableOpacity style={styles.backRightBtn} onPress={() => reOrder(rowMap, data.item.key)} >
